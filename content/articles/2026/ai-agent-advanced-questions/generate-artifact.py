...
artifact = {
    ...
    "slug": SLUG,
    "title": TITLE,
    "canonicalPath": f"/articles/{SLUG}/",
    "sourcePath": f"content/articles/2026/{SLUG}/article.md",
    "agentBriefPath": f"content/articles/2026/{SLUG}/agent.md",
    ...
    "related": [
        {"type": "article", "id": "article:ai-agent-first-conversation"}
    ],
    "agentInstructions": [
