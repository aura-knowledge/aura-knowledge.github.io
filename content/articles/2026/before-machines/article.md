...
summary: "A narrative history of calculation before electronics: human computers, abaci, Napier's rods, mechanical calculators, automata, Jacquard cards, and Babbage's engines."
readingTime: 10 min
agentArtifact: /agents/articles/before-machines.json
sourcePath: content/articles/2026/before-machines/article.md
---
...
<span id="claim-001" class="claim-marker" data-claim="claim-001">Claim C1</span> Computation was performed by people before it became associated with electronic machines.

<aside class="impact-callout" data-claim="claim-001">
  <strong>Impact:</strong> The word "computer" once named a job. Understanding that job keeps later machines in perspective: they automated work that was already organized, social, and imperfect.
</aside>

<h2 id="the-work-before-the-machine">The work before the machine</h2>
...
<h2 id="marks-counters-and-visible-memory">Marks, counters, and visible memory</h2>
...
<span id="claim-002" class="claim-marker" data-claim="claim-002">Claim C2</span> Counting boards and abaci moved arithmetic into visible physical state that could be manipulated and checked.
...
<aside class="analogy-limit" data-claim="claim-002">
  <strong>Analogy limit:</strong> Calling an abacus "working memory" helps show externalized calculation state, but the person supplies the algorithm and the meaning.
</aside>

<h2 id="tables-rods-and-reusable-steps">Tables, rods, and reusable steps</h2>
...
<aside class="analogy-limit" data-claim="claim-003">
  <strong>Analogy limit:</strong> Napier's rods make a procedure tangible, but they do not choose the method, verify the goal, or handle cases outside the precomputed breakdown.
</aside>

<span id="claim-003" class="claim-marker" data-claim="claim-003">Claim C3</span> Rods, tables, and logarithmic methods reduced complex calculations by decomposing or reusing prior work.
...
<aside class="analogy-limit" data-claim="claim-003">
  <strong>Analogy limit:</strong> A table is like cached work only in the sense that it stores precomputed results; it does not retrieve, reason, or verify by itself.
</aside>

<h2 id="when-gears-carried-the-operation">When gears carried the operation</h2>
...
<span id="claim-004" class="claim-marker" data-claim="claim-004">Claim C4</span> Seventeenth-century mechanical calculators embodied arithmetic operations in physical mechanisms.
...
<h2 id="the-dream-of-self-moving-mechanism">The dream of self-moving mechanism</h2>
...
<span id="claim-006" class="claim-marker" data-claim="claim-006">Claim C6</span> Automata made mechanism appear self-directed, inviting audiences to project life or agency onto fixed motion.
...
Against this backdrop, the Antikythera mechanism looks different. Where automata performed, the Antikythera mechanism calculated and displayed celestial cycles. Research published in <em>Nature</em> and summarized by NYU's Institute for the Study of the Ancient World describes it as a geared astronomical calculator or display mechanism for lunar phases, calendar cycles, and heavenly motions. Modern imaging projects, such as the one at the Max Planck Institute, continue to reveal inscriptions and reconstruct its functions—but reconstruction is not complete certainty.

<span id="claim-005" class="claim-marker" data-claim="claim-005">Claim C5</span> The Antikythera mechanism was a sophisticated geared astronomical calculator or display mechanism.
...
<h2 id="patterns-cards-and-controlled-sequence">Patterns, cards, and controlled sequence</h2>
...
<span id="claim-007" class="claim-marker" data-claim="claim-007">Claim C7</span> Jacquard punched cards controlled textile patterns and influenced later ideas about machine input and control.
...
<aside class="analogy-limit" data-claim="claim-007">
  <strong>Analogy limit:</strong> Jacquard cards are like stored instructions only for weaving patterns; they are not general symbolic programs.
</aside>
...
<span id="claim-008" class="claim-marker" data-claim="claim-008">Claim C8</span> Babbage's engines mark a threshold between mechanical arithmetic and designs for automatic computing machinery.
...
<aside class="impact-callout" data-claim="claim-008">
  <strong>Impact:</strong> The bridge to computing is not magic. It is the slow separation of symbol, rule, mechanism, and human judgment.
</aside>
