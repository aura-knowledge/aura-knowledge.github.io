---
schemaVersion: 1
id: article:the-green-revolution-trade-off
slug: the-green-revolution-trade-off
title: The Green Revolution Trade-Off
dek: India solved food scarcity with a technological package that later revealed water, soil, and diversity costs. Digital access has its own hidden bill.
date: "2026-07-05"
updated: "2026-07-05"
status: published
maturity: seed
...
tags:
  ...
  - analogy
  - long-term-thinking
summary: Uses the Green Revolution as an analogy for solving one urgent problem while creating slower, structural costs that only become visible later.
readingTime: 9 min
agentArtifact: /agents/articles/the-green-revolution-trade-off.json
...
<span id="claim-001" class="claim-marker" data-claim="claim-001">Claim C1</span> The Green Revolution dramatically increased cereal production and averted famine in India.

<h2 id="the-hunger-crisis-and-the-technological-fix">The Hunger Crisis and the Technological Fix</h2>
...
<span id="claim-002" class="claim-marker" data-claim="claim-002">Claim C2</span> It also led to groundwater depletion, soil salinity, and reduced crop diversity in several regions.

![Green Revolution output and water table trends](/images/articles/2026/attention-substance-ai-moment/green-revolution-trade-off.svg)
...
<h2 id="the-deferred-costs">The Deferred Costs</h2>
...
<span id="claim-003" class="claim-marker" data-claim="claim-003">Claim C3</span> The costs were delayed and diffuse, making them politically harder to address than the initial hunger crisis.

<h2 id="the-access-use-parallel">The Access-Use Parallel</h2>
...
<span id="claim-004" class="claim-marker" data-claim="claim-004">Claim C4</span> Universal digital access similarly solves an access crisis while creating attention, mental-health, and civic-cohesion costs that accumulate slowly.

<h2 id="what-the-analogy-does-and-does-not-claim">What the Analogy Does and Does Not Claim</h2>
...
- [Tobacco, Seatbelts, and Food Safety: How Societies Learn to Regulate Design](/articles/tobacco-seatbelts-food-safety/) — another historical frame on how societies move from "personal choice" to "design accountability."
- [The Jio Effect: Cheap Data and the Access-Behavior Paradox](/articles/the-jio-effect-cheap-data-access-behavior/) — the access story that sets up the use question.
- [By the Numbers: What Indians Actually Do Online](/articles/by-the-numbers-what-indians-do-online/) — the data picture behind the digital side of the analogy.
