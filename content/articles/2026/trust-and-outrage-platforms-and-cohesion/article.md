---
schemaVersion: 1
id: article:trust-and-outrage-platforms-and-cohesion
slug: trust-and-outrage-platforms-and-cohesion
title: "Trust and Outrage"
dek: "How attention platforms turn outrage into reach, and what that does to social trust in India."
date: 2026-07-05
updated: 2026-07-05
status: published
maturity: seed
...
tags:
  ...
  - polarization
  - platform-design
summary: "Examines the design incentives and evidence behind divisive-content amplification in India, from algorithmic feeds to misinformation and hate-speech trends, and asks whether platforms can be designed to reward cohesion instead of fracture."
readingTime: 7 min
agentArtifact: /agents/articles/trust-and-outrage-platforms-and-cohesion.json
...
<span id="claim-001" class="claim-marker" data-claim="claim-001">Claim C1</span> On major social platforms, engagement-based ranking systematically amplifies emotionally charged and divisive content because anger and moral outrage generate more likes, shares, and comments than neutral or constructive material.

<h2 id="the-outrage-reward-loop">The Outrage-Reward Loop</h2>

The mechanism is not mysterious. Platforms that rank content by engagement reward whatever keeps people interacting. A 2021 Yale study in *Science Advances* analyzed 12.7 million tweets and found that users who received more likes and shares for expressing moral outrage went on to express more outrage over time. The effect was strongest among users in politically moderate networks—precisely the people whose tone is most shaped by social feedback. <span id="claim-002" class="claim-marker" data-claim="claim-002">Claim C2</span> The researchers described it as a learning process: the platform teaches users, through visible rewards, that outrage is the language that travels.

A later large-scale audit by Milli et al., published in *PNAS Nexus*, compared engagement-based and chronological timelines on Twitter/X. The engagement-based algorithm amplified emotionally charged, out-group hostile content that users themselves said made them feel worse. Among political tweets, 62% in the engagement-based feed expressed anger, compared with 52% in the chronological feed. <span id="claim-003" class="claim-marker" data-claim="claim-003">Claim C3</span> The gap is not marginal; it is the predictable output of an optimization target that treats attention as the only success metric.
...
<h2 id="india-in-the-feed">India in the Feed</h2>

India is not a passive recipient of a global pattern. A 2022 study by researchers at Microsoft Research Bengaluru, published at the International AAAI Conference on Web and Social Media, analyzed 6,000 Indian influencers and 26,000 politicians during political crises. They found that 84% of influencers had a higher median retweet rate for tweets related to polarizing events than for their other tweets. <span id="claim-004" class="claim-marker" data-claim="claim-004">Claim C4</span> In other words, the outrage-reward loop operates domestically, and it rewards public figures who frame politics as conflict.

The consequences show up in harder measures. The World Economic Forum's *Global Risks Report 2024* ranked India highest among surveyed countries for misinformation and disinformation risk over the next two years. <span id="claim-005" class="claim-marker" data-claim="claim-005">Claim C5</span> Separately, the India Hate Lab documented 1,165 in-person hate-speech events targeting religious minorities in 2024, a 74.4% increase from 2023. The report notes that a large majority of these events were amplified through social media platforms including Facebook, X, and YouTube. <span id="claim-006" class="claim-marker" data-claim="claim-006">Claim C6</span>
...
If the problem were only bad actors, clearer rules and faster takedowns might be enough. But the deeper issue is accountability misaligned with scale. India is Meta's largest market by users, yet the Meta Oversight Board's 2023 annual report shows that Central and South Asia accounted for only 5% of the cases it selected for review. <span id="claim-008" class="claim-marker" data-claim="claim-008">Claim C8</span> The figure is a proxy, not a precise measure of safety spending, but it captures a familiar asymmetry: the region generates enormous engagement and revenue, while its grievances receive disproportionately little independent scrutiny.
...
<h2 id="can-platforms-reward-cohesion">Can Platforms Reward Cohesion?</h2>
...
Some of these ideas are explored later in this series, particularly in [Designing for Substance](/articles/designing-for-substance/). The point here is narrower: trust and cohesion are not luxuries that platforms can ignore until regulation forces action. They are preconditions for the public problem-solving—education, health, infrastructure, climate—that India and every large democracy depends on.
...
- [By the Numbers: What Indians Actually Do Online](/articles/by-the-numbers-what-indians-do-online/) — the digital time budget that feeds the outrage economy.
- [The Generational Bet](/articles/the-generational-bet/) — why the attention economy is an AI-era stakes question.
- [The Substance Builder](/articles/the-substance-builder/) — individual practice as a counterweight to extraction.
- [Designing for Substance](/articles/designing-for-substance/) — systemic alternatives to engagement-first design.
- [Attention, Substance, and the AI Moment](/articles/attention-substance-ai-moment/) — the full series guide.
