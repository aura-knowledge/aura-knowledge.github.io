---
schemaVersion: 1
id: article:tobacco-seatbelts-food-safety
slug: tobacco-seatbelts-food-safety
title: "Tobacco, Seatbelts, and Food Safety: How Societies Learn to Regulate Design"
dek: "Harmful products were once framed as personal choices. Over time, societies realized that design and marketing also matter."
date: 2026-07-05
updated: 2026-07-05
status: published
maturity: seed
...
tags:
  ...
  - history
summary: "Surveys public-health precedents to argue that attention-extraction platforms can be treated as design problems, not only user-responsibility problems."
readingTime: 10 min
agentArtifact: /agents/articles/tobacco-seatbelts-food-safety.json
...
Tobacco is the most familiar case. In the early 1900s cigarettes were marketed as soothing, modern, and even beneficial. Advertisements featured doctors and athletes. The frame was consumer choice, and the consumer was assumed to be free and informed. <span id="claim-001" class="claim-marker" data-claim="claim-001">Claim C1</span>
...
Seatbelts and food safety show a different but complementary pattern. Both were once treated as matters of personal care: fasten your own belt, inspect your own meat. Yet behavior changed most dramatically when the design itself changed. <span id="claim-002" class="claim-marker" data-claim="claim-002">Claim C2</span>
...
None of these cases followed a single path. Tobacco moved through epidemiology, litigation, and treaty law. Seatbelts moved through crash data, insurance pressure, and vehicle standards. Food safety moved through journalism, public outrage, and regulatory inspection. But they shared a sequence. <span id="claim-003" class="claim-marker" data-claim="claim-003">Claim C3</span>
...
```mermaid
timeline
    title From personal choice to design accountability
    section Tobacco
        1964 : U.S. Surgeon General report links smoking to disease
        1965 : Federal Cigarette Labeling and Advertising Act
        2003 : WHO Framework Convention on Tobacco Control
    section Seatbelts
        1968 : FMVSS 208 requires front seat belts in new cars
        1984 : New York enacts the first U.S. mandatory seatbelt law
        1990s : Reminder chimes and ignition interlocks spread
    section Food safety
        1906 : Pure Food and Drug Act creates federal oversight
        1938 : Federal Food, Drug, and Cosmetic Act expands safety rules
```
...
Attention-extraction platforms are earlier in the same arc. The harms are documented but not yet settled in law. The design choices are known but not yet treated as regulated defaults. <span id="claim-004" class="claim-marker" data-claim="claim-004">Claim C4</span>
